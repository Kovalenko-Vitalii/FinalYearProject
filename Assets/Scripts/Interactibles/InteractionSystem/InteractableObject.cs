...
public class InteractableObject : MonoBehaviour, IInteractable, IHoldInteractable, IHoldFeedback
{
    [SerializeField] string id;
    [SerializeField] string label;
    [SerializeField] private InteractableObject dependentOn;
...
public sealed class InteractContext
{
    ...
    public InteractContext(InteractableObject interactable, PlayerInteractor interactor)
    {
